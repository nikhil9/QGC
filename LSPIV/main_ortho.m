...
title_figure = 'Orthorectification of images:';

cell_list{1,1} = {'1 - GRPs Localization ','GRP_main;'};
cell_list{2,1} = {'2 - Transformation Parameterization','transf_gui;'};
cell_list{3,1} = {'3 - Transform all the images','transf_all2;'};
cell_list{4,1} = {'Go back to previous menu','main_LSPIV;'};
cell_list{5,1} = {'Stop application',['disp(''Bye. To run again, type Mat_LSPIV''); close(' num2str(fig_number) ');']}; %{'Exit','calib_gui;'};
