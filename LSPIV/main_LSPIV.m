...
title_figure = 'LSPIV Procedure:';
%cell_list{1,1} = {'1 - Pre Processing ','main_pre;'};
cell_list{1,1} = {'1 - Orthorectification ','main_ortho;'};
cell_list{2,1} = {'2 - PIV Analysis','main_PIV;'};
cell_list{3,1} = {'3 - Post Processing','main_post;'};
cell_list{4,1} = {'Stop application',['disp(''Bye. To run again, type Mat_LSPIV''); close(' num2str(fig_number) ');']}; %{'Exit','calib_gui;'};
