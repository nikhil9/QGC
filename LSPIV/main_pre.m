...
title_figure = 'Pre-Processing:';

cell_list{1,1} = {'Histogram equalization','hist_equal;'};
cell_list{2,1} = {'Contrast adjustment','contrast;'};
cell_list{3,1} = {'Go back to previous menu','main_LSPIV;'};
cell_list{4,1} = {'Exit',['disp(''Bye. To run again, type LSPIV''); close(' num2str(fig_number) ');']}; %{'Exit','calib_gui;'};
